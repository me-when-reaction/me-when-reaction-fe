...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "IX_tr_image_tag_image_id" ON "tr_image_tag" USING btree (image_id uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "IX_tr_image_tag_tag_id" ON "tr_image_tag" USING btree (tag_id uuid_ops);
*/